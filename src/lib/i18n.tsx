...
const EN: Dict = {
  ...
  'nav.treatment': 'Treatment & learning', 'nav.messages': 'Messages',
...
const ES: Dict = {
  ...
  'nav.treatment': 'Tratamiento y aprendizaje', 'nav.messages': 'Mensajes',
...
const FR: Dict = {
  ...
  'nav.treatment': 'Traitement et apprentissage', 'nav.messages': 'Messages',
